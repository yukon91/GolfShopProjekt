...
{
    /// <inheritdoc />
<<<<<<<< Updated upstream:GolfShopHemsida/GolfShopHemsida/Migrations/20250416111749_MergeUpdate.cs
    public partial class MergeUpdate : Migration
========
    public partial class itemfix : Migration
>>>>>>>> Stashed changes:GolfShopHemsida/GolfShopHemsida/Migrations/20250416125944_itemfix.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Betalsätt = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FollowUsers", x => new { x.FollowerId, x.FollowedId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_AspNetUsers_GolfShopUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comments_AspNetUsers_GolfShopUserId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_GolfShopUserId",
                table: "Comments",
                column: "GolfShopUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_GolfShopUserId1",
                table: "Comments",
